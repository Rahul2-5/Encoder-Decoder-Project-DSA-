...
class HuffmanCoder {
    ...
    private class Node implements Comparable<Node> {
        ...
        public Node(Character data, int cost) {  // used to compare two nodes
            this.data = data;
        ...
        public int compareTo(Node other) {
            return this.cost - other.cost; // when its negative means its smaller ,
                                            // when its positive means bigger
